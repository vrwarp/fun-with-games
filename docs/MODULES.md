...
| **render**         | `src/render/`                                                                                             | `Renderer`, `EntityViews`, `KitViews`, `TrackView`, `KeyboardInput`, `TouchInput`, `TouchButtons` | shared, sim types, net view | Babylon scene, meshes, kit visuals (zones/ball/projectiles/items), circuits, follow-camera, input (keyboard **and** touch **and** action buttons), device APIs.                  |
